...
| [HOOD](wiki/tickers/HOOD/HOOD.md) | Active | 2026-04-29 | Multi-stream financial super-app post-transformation (FY25 rev +52%, adj EBITDA +76%); Q1 2026 confirmed diversification (NII +24%, event contracts +320%, Gold +36%) absorbing crypto –47%. Initiate (non-holder) at $84.71; Hold (holder). PW EV ~$108 (+27%); R/R ~2.4:1. |
...
| [WING](wiki/tickers/WING/WING.md) | Active | 2026-04-29 | Q1 FY26 domestic SSS **–8.7%** activated the wiki's defined thesis-break trigger; FY26 guide cut to "low-single-digit DECLINE." Stock –12.5% post-print to $165. EBITDA / EPS resilience preserved (Q1 +9.9% / +28%) but cyclical-vs-structural debate is now genuinely contested. **Watch (non-holder) / Reduce on bounce (holder)**; next read = Q2 print late July. |
...
*37 tickers above. Last refresh: 2026-04-29 (HOOD v2 initial ingest; WING Q1 FY26 earnings update — thesis-break trigger activated).*
