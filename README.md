...
| [HD](wiki/tickers/HD/HD.md) | Active | 2026-05-18 | Pre-Q1 price-action update — slid to **$297.51** (2026-05-15, fresh 52-wk low, –7.5% vs. $321.75 baseline, ~0–1st %ile) on housing-rate freeze (~60%) + pre-earnings analyst target-cut cluster that kept Buy ratings (~30%); **no company-specific deterioration**. More opportunity than threat, conditional on the May 19 Q1 print. PW EV ~$377 (+27%); R/R ~2.8:1 (PW ~4:1); FY26E P/E ~19× decade-low. Entry re-cut $280–$320 — spot inside. **🟢 Initiate (scaled) / 🟡 Hold, add-leaning**; Q1 FY26 May 19 (post-print review required). |
