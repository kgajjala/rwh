...
| [SBUX](wiki/tickers/SBUX/SBUX.md) | Active | 2026-04-26 | Wide-moat coffee in credible Niccol turnaround — Q1 FY26 first U.S. txn inflection in 8 quarters; **April 2026 Boyu China JV close ($13B EV) removes multi-year overhang**; PW EV $117 (+18% / ~6%/yr + 2.5% div). **Watch / Hold**; entry $85–92; Q2 Apr 28 binary. |
...
| [UNH](wiki/tickers/UNH/UNH.md) | Active | 2026-04-26 | Wide-moat #1 managed care with **MLR-recovery thesis confirmed** by Q1 2026 BEAT (Apr 21) — MCR 83.9%, Adj EPS +9.7%, FY26 guide raised >$18.25; Hemsley-led normalization on accelerated timing. Quadruple BAIT (B-compressed post-recovery). PW EV $415 (+17% / 24mo). **Initiate / Add**. |
...
*35 tickers above. Last refresh: 2026-04-26 (v2.9 retrofit batch — 22 tickers updated to v2.9; 11 tickers preserved at v2.8 per user direction; SHOP and DASH at v2.9 from prior session).*
