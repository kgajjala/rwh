...
|--------|---------|------|-----------|--------------|--------|
| [BKNG](tickers/BKNG/overview.md) | Booking Holdings | Wide | High | 2026-04-05 | Active — full thesis compiled |
| [LLY](tickers/LLY/overview.md) | Eli Lilly | Wide | High | 2026-04-05 | Active — full thesis compiled; FCF/capex detail pending 10-K |
...
| Position Sizing | Stock vs. options %, staged entry rules | [frameworks/position-sizing.md](frameworks/position-sizing.md) |
...
| Page | Description |
|------|-------------|
| [watchlist.md](watchlist.md) | Cross-ticker ranking, conviction, allocation |
