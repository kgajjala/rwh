...
Per Rule #23, this table excludes universal corporate boilerplate (e.g., generic cyber, generic third-party reliance). It focuses on risks that are (a) materially differentiated from peers, (b) not yet priced in, (c) tied to a thesis-break trigger, or (d) tied to a large discretionary investment.
