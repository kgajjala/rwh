...
*Horizons noted in last column. SCHW, BKNG, LLY targets refreshed in v2.1 migration.*
...
|----------------|-------------------------|-------------------|
| Federal Reserve rate path | SCHW NIM (positive if no cuts); BKNG/DASH/WING consumer (negative if rate-driven slowdown) | No-cut environment = SCHW positive; cut cycle = SCHW NIM headwind, others mixed |
| U.S. consumer health | WING SSS; BKNG room nights; DASH order frequency; LLY Zepbound demand | Consumer stress = WING / DASH pressure; BKNG more resilient (international); LLY discretionary GLP-1 |
...
| 30-year mortgage rates | RKT origination volume (critical); SCHW NIM (indirect) | Sustained <6.25% = RKT bull trigger; >7.5% = RKT bear |
| Housing lock-in effect unlock | RKT purchase volume + Redfin traffic | Rate relief → unlock → RKT volume surge |
