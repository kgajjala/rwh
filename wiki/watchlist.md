...
*Updated: 2026-05-31 — LOW Workflow A ingest (added #20b): #2 US home improvement at $214 near 52-wk low; ~17× FY26E P/E (6× discount to HD); housing lock-in + FBM ($8.8B, 13.4× EBITDA) integration risk priced in; Dividend King (63 consec. raises); PW EV $322 (+50%); R/R ~4.9:1; Initiate / Hold-Add; entry ≤$260; Q2 FY26 ~Aug. Also: ACN Workflow B + v3.0 upgrade: price $168.82→$187.07 (May 29 close); R/R 3.3:1→2.2:1; upside +38%→+25%; Watch/Initiate-on-dips/Hold (spot just above 20% MoS entry ceiling); OpenAI Federal partnership (May 14) added; Outsider-leaning grade assigned; Q3 FY26 earnings confirmed Jun 18. Ranks 8b + 20b updated; earnings calendar updated.*
...
| 28b | HD | Moderate-High (pre-Q1 price-action; entry zone reached) | Double (B+A) | PW EV ~$377 vs. **$297.51** (2026-05-15 fresh 52-wk low) = **+27%** (5yr incl. 2.9% div); R/R **~2.8:1** spot (PW-weighted ~4:1); ~0–1st %ile — slide ~60% housing-rate / ~30% pre-earnings target-cut cluster (Buy ratings kept) / no company-specific break | **🟢 Initiate (scaled) / 🟡 Hold, add-leaning**; entry re-cut $280–320 (spot inside) | Q1 FY2026 — May 19, 2026 (post-print review required) |
